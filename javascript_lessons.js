...
include any I/O (https://en.wikipedia.org/wiki/Input/output),
...
// js demo - styling elements

document.getElementsByTagName("h1")[0].style.color = "#ff0000"

// js demo - styling elements css
...
// to clear console run clear() method
clear();
...
==        Equal to
===       Equal to and Same Type (Strict Equality)
!=        Not Equal to
...
console.log("Size Not Found.  You must not be from Planet Earth");
}
...
var prize = "";
var winner = parseInt(prompt("What number winner are you", 3));
...
The "use strict" directive was new in ECMAScript version 5. It is not a
statement, but a literal expression, ignored by earlier versions of JavaScript.
The purpose of "use strict" is to indicate that the code should be executed in
"strict mode". With strict mode, you can not, for example, use undeclared
variables.
...
variable or a function name, is visible or accessible.  Analogy, asking where to
...
functions in the program can access variables defined in global scope

function scope - dentifiers can be accessed everywhere inside the function it
...
commonly used in JavaScript, and can be helpful in streamlining your code.
...
ParametersSection
start
Index at which to start changing the array (with origin 0). If greater than the
length of the array, actual starting index will be set to the length of the
array. If negative, will begin that many elements from the end of the array
(with origin -1, meaning -n is the index of the nth last element and is
therefore equivalent to the index of array.length - n) and will be set to 0 if
...
array.length - start (that is, if it is equal to or greater than the number
of elements left in the array, starting at start), then all of the elements
from start through the end of the array will be deleted.
...
Return valueSection
An array containing the deleted elements. If only one element is removed, an
...
// Returns: []
var donuts = ["glazed", "chocolate frosted", "Boston creme", "glazed cruller"];
donuts.splice(1, 0, "chocolate cruller", "creme de leche");

// new arrary after splice
donuts array: ["glazed", "chocolate cruller", "creme de leche", "chocolate frosted", "Boston creme", "glazed cruller"]


// Returns: []
var donuts = ["glazed", "chocolate frosted", "Boston creme", "glazed cruller"];
donuts.splice(1, "chocolate cruller", "creme de leche");

// new arrary after splice
donuts array: ["glazed", "creme de leche", "chocolate frosted", "Boston creme", "glazed cruller"]


// Returns: ["chocolate frosted", "Boston creme", "glazed cruller"]
var donuts = ["glazed", "chocolate frosted", "Boston creme", "glazed cruller"];
donuts.splice(1);
